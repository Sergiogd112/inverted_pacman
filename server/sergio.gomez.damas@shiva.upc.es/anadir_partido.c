...
//
//
//void introducir_partido(int *lista_id_usuario, int *lista_puntuaciones, int num_valores, int **argv) //num_valores es la cantidas de usuarios-puntuaciones que a�adira.
//{
//	MYSQL *conn;
//	int err;
//
