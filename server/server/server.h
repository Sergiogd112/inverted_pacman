...
void insert(struct Node** head_ref, int new_id, int new_sockfd) {
...
void append(struct Node** head_ref, int new_id, int new_sockfd) {
	// allocate memory for new node
	struct Node* new_node = (struct Node*)malloc(sizeof(struct Node));
	// assign data to new node
	new_node->id = new_id;
...
int search(struct Node* head, int target_id) {
...
int remove_node(struct Node** head_ref, int target_id) {
